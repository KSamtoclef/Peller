(function(){
'use strict';
const KEY='pellerWeddingApplicationV4';
...
function startOffer(network){state.network=network;save();prefill();show('loader');$('#loaderPercent').textContent='0%';animatePercent($('#loaderPercent'),null,1250,()=>setTimeout(()=>show('phoneStep'),220));}
